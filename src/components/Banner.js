...
const Banner = () => {
  return (
    <Section>
        <ImgContainer>
        <img src={img1} alt='Duckies'/>
        <img src={img2} alt='Duckies'/>
        <img src={img3} alt='Duckies'/>
        <img src={img4} alt='Duckies'/>
        <img src={img5} alt='Duckies'/>
        <img src={img6} alt='Duckies'/>
        </ImgContainer>
        <Title>Become a member of the <br /> Duckies Squad</Title>
        <BtnContainer>
            <JoinNow>
                Join Now
            </JoinNow>
