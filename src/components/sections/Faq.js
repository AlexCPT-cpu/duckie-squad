    ...
    <Section ref={ref} id='faq'>
      ...
      <Container>
        <Box>
          ...
          The Duckies Squad is a collection of 3,000 NFTs—unique digital collectibles, stored as ERC-721 tokens on the Binance Smart Chain.
            </Accordion>
          <Accordion title="WHERE CAN I VIEW MY NFTS?" >
          Once minted or bought simply connect to TofuNFT or NFYKEY to view your NFTs.
            </Accordion>
            ...
            The amount of royalties will be fixed at 5% to finance the Duckies Squad projects. We have the ambition to organize multiple events in order to strengthen the community and build our ecosystem.
            </Accordion>
        </Box>
        <Box>
