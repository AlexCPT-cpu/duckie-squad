...
export const Team = () => {
  return (
    <Section id='team'>
      ...
      <Container>
        <MemberComponent img={img1} name='ICE' position='Founder' />
        <MemberComponent img={img2} name='ABERAMA' position='Blockchain Specialist' />
        <MemberComponent img={img6} name='CLANCY' position='Advisor' />
