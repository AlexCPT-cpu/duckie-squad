  ...
  return (
    <Section id='team'>
      ...
      <Container>
        ...
        <MemberComponent img={img3} name='KAYE' position='Director' />
        <MemberComponent img={img4} name='JACKSON' position='Moderator' />
        <MemberComponent img={img5} name='SÏMON' position='social media manager' />
        <MemberComponent img={img6} name='JAY' position='Advisor' />
        <MemberComponent img={img7} name='FAVOUR' position='Marketer' />
        <MemberComponent img={img8} name='ALEX' position='Web3 Developer' />
